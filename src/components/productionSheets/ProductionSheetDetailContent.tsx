...
import { ScaledIngredientsSection } from './ScaledIngredientsSection';
import { TotalIngredientsTable } from './TotalIngredientsTable';
import type { RecipeScaledIngredients, AggregatedIngredient } from '@/lib/ingredientAggregation';

interface ProductionSheetDetailContentProps {
  productionSheet: {
    id: string;
    ...
    usages: Array<{
      ...
      shortfall: { toString(): string } | number;
      notes: string | null;
      lot: {
        purchasedAt: Date;
        purchaseUnit: string;
  ...
  scaledRecipes: RecipeScaledIngredients[];
  aggregatedIngredients: AggregatedIngredient[];
  totalCost: number;
  recipesForTable: Array<{
    id: string;
    recipeId: string;
    scale: number;
    order: number;
...
export function ProductionSheetDetailContent({
  productionSheet,
  scaledRecipes,
  aggregatedIngredients,
  totalCost,
  recipesForTable,
}: ProductionSheetDetailContentProps) {
  return (
